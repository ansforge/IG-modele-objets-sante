# FonctionqualifieeVs - Modèle des Objets de Santé (MOS) v0.1.0
...
| Draft as of 2025-12-02 | *Computable Name*:FonctionqualifieeVs |
...
* Inclut tous les codes définis dans [`https://mos.esante.gouv.fr/NOS/TRE_R45-FonctionQualifiee/FHIR/TRE-R45-FonctionQualifiee`](https://interop.esante.gouv.fr/terminologies/1.1.0/CodeSystem-TRE-R45-FonctionQualifiee.html)version 📦20231215120000
...
* [codesystem TRE_R45_FonctionQualifiee v20231215120000 (CodeSystem)](https://interop.esante.gouv.fr/terminologies/1.1.0/CodeSystem-TRE-R45-FonctionQualifiee.html)

Ce jeu de valeur (ValueSet) contient 330 concepts
