# DispositifMedical - Modèle des Objets de Santé (MOS) v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/mos/StructureDefinition/DispositifMedical | *Version*:0.1.0 |
| Draft as of 2025-12-02 | *Computable Name*:DispositifMedical |
...
* Utiliser ce Modèle logique: [EntiteJuridique](StructureDefinition-EntiteJuridique.md) and [NoteLiaison](StructureDefinition-NoteLiaison.md)
