# ArretTravail - Modèle des Objets de Santé (MOS) v0.1.0
...
| Draft as of 2025-12-02 | *Computable Name*:ArretTravail |
...
* Utiliser ce Modèle logique: [VieProfessionnelle](StructureDefinition-VieProfessionnelle.md)
