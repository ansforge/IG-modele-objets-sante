# ExerciceProfessionnel - Modèle des Objets de Santé (MOS) v0.1.0
...
| Draft as of 2025-10-17 | *Computable Name*:ExerciceProfessionnel |
        ...
        "type" : [
          {
            "code" : "Reference",
            "targetProfile" : [
              "https://interop.esante.gouv.fr/ig/mos/StructureDefinition/Professionnel"
            ]
          }
        ]
      }
