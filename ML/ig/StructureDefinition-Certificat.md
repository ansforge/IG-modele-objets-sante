# Certificat - Modèle des Objets de Santé (MOS) v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/mos/StructureDefinition/Certificat | *Version*:0.1.0 |
| Draft as of 2025-12-02 | *Computable Name*:Certificat |
...
* Utiliser ce Modèle logique: [CarteProfessionnel](StructureDefinition-CarteProfessionnel.md), [EntiteGeographique](StructureDefinition-EntiteGeographique.md), [EntiteJuridique](StructureDefinition-EntiteJuridique.md) and [ExerciceProfessionnel](StructureDefinition-ExerciceProfessionnel.md)
