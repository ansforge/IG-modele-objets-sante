...
| Draft as of 2025-12-02 | *Computable Name*:Patientele |
...
* Utiliser ce Modèle logique: [ActiviteSociale](StructureDefinition-ActiviteSociale.md), [OffreOperationnelle](StructureDefinition-OffreOperationnelle.md) and [PlageReference](StructureDefinition-PlageReference.md)
