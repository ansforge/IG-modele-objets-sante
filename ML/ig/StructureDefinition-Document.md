...
| Draft as of 2025-12-02 | *Computable Name*:Document |
...
* Utiliser ce Modèle logique: [Demande](StructureDefinition-Demande.md), [DossierPersonnePriseCharge](StructureDefinition-DossierPersonnePriseCharge.md) and [NoteLiaison](StructureDefinition-NoteLiaison.md)
