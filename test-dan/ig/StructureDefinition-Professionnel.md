# Professionnel - Modèle des Objets de Santé (MOS) v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/mos/StructureDefinition/Professionnel | *Version*:0.1.0 |
| Draft as of 2026-03-12 | *Computable Name*:Professionnel |
...
```json
{
  ...
  "title" : "Professionnel",
  "status" : "draft",
  "date" : "2026-03-12T13:48:13+00:00",
  ...
  "differential" : {
    ...
    {
      "id" : "Professionnel.attributTest",
      "path" : "Professionnel.attributTest",
      "short" : "Libellé définition",
      "definition" : "Libellé short",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Identifier"
