...
* DESCNonQualifiant 0..1 Coding " Diplôme d'études spécialisées complémentaires (DESC)." " Diplôme d'études spécialisées complémentaires (DESC)."
* DESCNonQualifiant from https://interop.esante.gouv.fr/ig/fhir/mos/ValueSet/DESCNonQualifiant-vs (preferred)