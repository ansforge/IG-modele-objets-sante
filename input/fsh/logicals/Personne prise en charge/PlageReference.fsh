...
* ResultatObservation 1..1 https://interop.esante.gouv.fr/ig/mos/StructureDefinition/ResultatObservation "Lien vers la classe ResultatObservation" "Lien vers la classe ResultatObservation"