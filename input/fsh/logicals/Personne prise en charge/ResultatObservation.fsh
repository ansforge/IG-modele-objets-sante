...
* Observation 1..1 https://interop.esante.gouv.fr/ig/mos/StructureDefinition/Observation "Lien vers la classe Observation" "Lien vers la classe Observation"
* PlageReference 0..* https://interop.esante.gouv.fr/ig/mos/StructureDefinition/PlageReference "Lien vers la classe PlageReference" "Lien vers la classe PlageReference"