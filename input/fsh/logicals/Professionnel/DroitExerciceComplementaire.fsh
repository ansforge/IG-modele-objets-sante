...
* droitExerciceComplementaire 0..1 Coding "Droit d'exercice complémentaire." "Droit d'exercice complémentaire."
* droitExerciceComplementaire from https://interop.esante.gouv.fr/ig/fhir/mos/ValueSet/droitExerciceComplementaire-vs (preferred)