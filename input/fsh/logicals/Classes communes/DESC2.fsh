...
* DESC2 0..1 Coding "Diplôme d'études spécialisées complémentaires qualifiants (DESC II)." "Diplôme d'études spécialisées complémentaires qualifiants (DESC II)."
* DESC2 from https://mos.esante.gouv.fr/NOS/TRE_R51-DESCGroupe2Diplome/FHIR/TRE-R51-DESCGroupe2Diplome?vs (preferred)