...
* typeDiplome from https://interop.esante.gouv.fr/terminologies/CodeSystem-TRE-R14-TypeDiplome?vs (preferred)
...
* lieuFormation from https://interop.esante.gouv.fr/terminologies/CodeSystem-TRE-R16-LieuFormation?vs (preferred)
