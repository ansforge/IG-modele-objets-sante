...
* diplomeEES 0..1 Coding " Diplôme européen d'études spécialisées." " Diplôme européen d'études spécialisées."
* diplomeEES from https://interop.esante.gouv.fr/terminologies/CodeSystem-TRE-R57-DiplomeEuropeenEtudeSpecialisee?vs (preferred)