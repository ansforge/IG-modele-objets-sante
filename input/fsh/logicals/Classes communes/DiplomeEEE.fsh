...
* diplomeEEE 0..1 Coding "Diplôme d'un pays de l'espace économique européen." "Diplôme d'un pays de l'espace économique européen."
* diplomeEEE from https://mos.esante.gouv.fr/NOS/TRE_R53-DiplomePaysEEE/FHIR/TRE-R53-DiplomePaysEEE?vs (preferred)