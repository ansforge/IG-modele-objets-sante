Logical: SurspecialiteTransversale
...
* surspecialiteTransversale 0..1 Coding " Surspécialité acquise par le professionnel en supplément de la spécialité de DES." " Surspécialité acquise par le professionnel en supplément de la spécialité de DES."
* surspecialiteTransversale from https://interop.esante.gouv.fr/ig/fhir/mos/ValueSet/surspecialiteTransversale-vs (preferred)