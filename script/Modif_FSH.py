...
ref_pro_1 = '* professionnel 1..1 Reference(Professionnel) "Lien vers la classe Professionnel" '
...
ref_pro_3 = '* exerciceProfessionnel 1..1 Reference(ExerciceProfessionnel) "Lien vers la classe ExerciceProfessionnel." '
...
ref_pro_4 = '* exerciceProfessionnel 1..1 Reference(ExerciceProfessionnel) "Lien vers la classe ExerciceProfessionnel."'
add_line_fsh(situationOperationnelle_path, ref_pro_4)

savoirFaire_path = "../input/fsh/logicals/Professionnel/SavoirFaire.fsh"
ref_pro_5 = '* exerciceProfessionnel 1..1 Reference(ExerciceProfessionnel) "Lien vers la classe ExerciceProfessionnel."'
...
cartepro_path = "../input/fsh/logicals/Structure/CarteProfessionel.fsh"
ref_DA_1 = '* certificat 1..* Reference(Certificat) "Lien vers la classe Certificat."'
