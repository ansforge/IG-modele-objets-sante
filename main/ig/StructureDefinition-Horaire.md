# Horaire - Modèle des Objets de Santé (MOS) v0.1.0
...
| Draft as of 2025-12-03 | *Computable Name*:Horaire |
...
* Utiliser ce Modèle logique: [SituationOperationnelle](StructureDefinition-SituationOperationnelle.md)
